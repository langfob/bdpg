...
read_Xu_problem_from_Xu_file <- function (infile_name, given_correct_solution_cost) 
    ...
    PU_spp_pair_info@PU_spp_pair_indices <- PU_spp_pair_indices_sextet$PU_spp_pair_indices
    PU_spp_pair_info@PU_col_name <- PU_spp_pair_indices_sextet$PU_col_name
    PU_spp_pair_info@spp_col_name <- PU_spp_pair_indices_sextet$spp_col_name
    PU_spp_pair_info@num_PUs <- PU_spp_pair_indices_sextet$num_PUs
    PU_spp_pair_info@num_spp <- PU_spp_pair_indices_sextet$num_spp
    PU_spp_pair_info@correct_solution_cost <- PU_spp_pair_indices_sextet$correct_solution_cost
    ...
    PU_spp_pair_info@nodes = NULL    #  Is there actually a way that these ARE known at this point?  Not immediately obvious.  Not even sure if it's necessary though...
...
test_create_eligible_PU_set <- function ()
    ...
    Xu_dep_set = 3:6
    Xu_tot_num_PUs = 6
    tot_num_PUs_in_landscape = 10
    extra_PUs = (Xu_tot_num_PUs + 1) : tot_num_PUs_in_landscape
    
    eligible_PUs_WITH_dep_set = create_eligible_PU_set (Xu_dep_set, extra_PUs, 
                                                        TRUE)
    correct_result_WITH = 3:10
    expect_equal (eligible_PUs_WITH_dep_set, correct_result_WITH)
    
    
    eligible_PUs_withOUT_dep_set = create_eligible_PU_set (Xu_dep_set, extra_PUs, 
                                                           FALSE)
    correct_result_withOUT = 7:10
    expect_equal (eligible_PUs_withOUT_dep_set, correct_result_withOUT)
    }
...
gen_multi_bdprob = function (wrap_lognormal_dist_around_Xu, read_Xu_problem_from_Xu_file, infile_name, given_correct_solution_cost, max_allowed_num_spp, bdpg_error_codes, integerize)  #parameters, bdpg_error_codes, integerize)
    ...
    bdprob_1 = gen_single_bdprob (read_Xu_problem_from_Xu_file, infile_name, given_correct_solution_cost, max_allowed_num_spp, bdpg_error_codes, integerize)  #parameters, bdpg_error_codes, integerize)
    ...
    if (bdprob_1@prob_is_ok)
        {
         if (wrap_lognormal_dist_around_Xu)  #parameters$wrap_lognormal_around_Xu)
            ...
            search_outfile_name             = "/Users/bill/D/Projects/ProblemDifficulty/src/bdprobdiff/R/outfile.csv"
            ...
            bdprob_2 = gen_single_bdprob (read_Xu_problem_from_Xu_file, infile_name, given_correct_solution_cost, max_allowed_num_spp, bdpg_error_codes, integerize)  #parameters, bdpg_error_codes, integerize)
