...
source('~/D/Projects/ProblemDifficulty/pkgs/bdpg/R/gscp_11aa_write_abbreviated_results_to_files.R')
...
#test_file("/Users/bill/D/Projects/ProblemDifficulty/pkgs/bdpg/tests/testthat/test_validation_functions.R")
