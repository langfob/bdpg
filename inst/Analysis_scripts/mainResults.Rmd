...
Also show all output error fractions values below 1
...
gg_eucInTot_vs_sppRepShortfall_all_on_1 <- function (rs_name,
    ...
    ggplot (data = sorted_msa_tib) +
            aes(x = rsp_euc_realized_Ftot_and_cost_in_err_frac,
                                        y = rsr_APP_spp_rep_shortfall, #rsr_COR_euc_out_err_frac,
            #                            color = rsp_combined_err_label)) +
                                        color = rsp_base_wrap_str) +
            geom_point() +
            scale_color_manual(breaks = c("Base", "Wrap"), values=c("red", "blue")) +
...
easyHard_df_Marxan_SA %>% 
    filter (rsr_COR_euc_out_err_frac <= 1) -> not_huge_out_err_df
gg_eucInTot_vs_signedCostErrFrac_all_on_1 ("Marxan_SA", not_huge_out_err_df, ref_y = 0)
gg_eucInTot_vs_signedCostErrFrac_facetted_by_err_label ("Marxan_SA", not_huge_out_err_df, ref_y = 0)
...
easyHard_df_Marxan_SA %>% 
    filter (rsr_COR_euc_out_err_frac <= 1) -> not_huge_out_err_df
gg_eucInTot_vs_sppRepShortfall_all_on_1 ("Marxan_SA", not_huge_out_err_df, ref_y = 0)
gg_eucInTot_vs_sppRepShortfall_facetted_by_err_label ("Marxan_SA", not_huge_out_err_df, ref_y = 0)
...
gg_sppRepShortfall_vs_signedCostErrFrac_all_on_1 <- function (rs_name,
    ...
    {
    ggplot (data = sorted_msa_tib) +
            aes(x = rsr_APP_spp_rep_shortfall,
                                        y = rs_solution_cost_err_frac, #rsr_COR_euc_out_err_frac,
            #                            color = rsp_combined_err_label)) +
                                        color = rsp_base_wrap_str) +
            geom_point() +
...
gg_sppRepShortfall_vs_signedCostErrFrac_facetted_by_err_label <- function (rs_name,
    ...
    {
    ggplot (data = sorted_msa_tib) +
      geom_point (mapping = aes(x = rsr_APP_spp_rep_shortfall,
                                y = rs_solution_cost_err_frac,
    #                            color = rsp_combined_err_label)) +
                                color = rsp_base_wrap_str)) +
    #scale_color_viridis(discrete=TRUE) +
...
easyHard_df_Marxan_SA %>% 
    filter (rsr_COR_euc_out_err_frac <= 1) -> not_huge_out_err_df
gg_sppRepShortfall_vs_signedCostErrFrac_all_on_1 ("Marxan_SA", not_huge_out_err_df, ref_y = 0)
gg_sppRepShortfall_vs_signedCostErrFrac_facetted_by_err_label ("Marxan_SA", not_huge_out_err_df, ref_y = 0)
...
easyHard_df_Marxan_SA %>% 
    filter (rsr_COR_euc_out_err_frac <= 1) -> not_huge_out_err_df
gg_eucInTot_vs_fracPossibleOver_all_on_1 ("Marxan_SA", not_huge_out_err_df, ref_y = 0)
gg_eucInTot_vs_fracPossibleOver_facetted_by_err_label ("Marxan_SA", not_huge_out_err_df, ref_y = 0)
...
easyHard_df_Marxan_SA %>% 
    filter (rsr_COR_euc_out_err_frac <= 1) -> not_huge_out_err_df
gg_eucInTot_vs_fracPossibleUnder_all_on_1 ("Marxan_SA", not_huge_out_err_df, ref_y = 0)
gg_eucInTot_vs_fracPossibleUnder_facetted_by_err_label ("Marxan_SA", not_huge_out_err_df, ref_y = 0)
