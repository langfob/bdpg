...
#===============================================================================
    ...
    #  Input paths
batch_A_base_path = "/Users/bill/D/Projects/ProblemDifficulty/Results/ExpGen6basicVariants/Batch_3_500_FN_2rs/"
batch_B_base_path = "/Users/bill/D/Projects/ProblemDifficulty/Results/ExpGen6basicVariants/Batch_4_500_Xu_frac/"

    #  Output file path for data after cleaning here.
exp_cln_dir = "/Users/bill/D/Projects/ProblemDifficulty/Results/ExpGen6basicVariants/Combined_batches_3_4/Clean/"
cln_exp_path = paste0 (exp_cln_dir, "cln_exp.")
...
batch_A_df = load_input_data (rs_name, batch_A_base_path, suffix)
batch_B_df = load_input_data (rs_name, batch_B_base_path, suffix)
...
```{r combineBatches}
exp_df = bind_rows (batch_A_df, batch_B_df,  .id = "id")
...
While cleaning the data, some rows may be removed or modified.  To document what's been done and where to find where it was done, do two things.  First, add a column called "cln_mod" to the original data set.  Second, create a new, empty data set that will contain all lines removed from the data set during cleaning.  
...
# COR_batch_A_df = filter (batch_A_df, rsp_cor_or_app_str == "COR")
# #glimpse (COR_batch_A_df)
# APP_batch_A_df = filter (batch_A_df, rsp_cor_or_app_str == "APP")
# #glimpse (APP_batch_A_df)

# COR_batch_B_df = filter (batch_B_df, rsp_cor_or_app_str == "COR")
# #glimpse (COR_batch_B_df)
# APP_batch_B_df = filter (batch_B_df, rsp_cor_or_app_str == "APP")
# #glimpse (APP_batch_B_df)

# getColsWithNonZeroNAct (COR_batch_A_df)
# getColsWithNonZeroNAct (APP_batch_A_df)
# getColsWithNonZeroNAct (COR_batch_B_df)
# getColsWithNonZeroNAct (APP_batch_B_df)
```
