...
#  ALSO NEED TO ADD OTHER PREDICTIONS
...
```{r}
working_train_df = working_df [1:500, ]
working_test_df = working_df [501:1000, ]
```
...
TESTING FUNCTION CALL USING ALGAE DATA SET FROM TORGO'S BOOK - 2018 11 26 18 12
