...
gg_eucInTot_vs_eucOutTot_facetted_by_id <- function (rs_name,
 ...
 color = id
    ...
    ggtitle (paste0 (rs_name, " - Total input error vs. Total output error by Batch ID")) +
    theme(plot.title = element_text(hjust = 0.5)) +    #  To center the title
...
gg_rsp_realized_FN_rate_vs_eucOutTot_facetted_by_FN_dominance <- function (rs_name,
 ...
 color = id
    ...
    ggtitle (paste0 (rs_name, " - Realized FN rate vs. Total output error by Error Class")) +
    theme(plot.title = element_text(hjust = 0.5)) +    #  To center the title
...
gg_rsp_num_PUs_vs_eucOutTot_facetted_by_FN_dominance <- function (rs_name,
 ...
 color = id
    ...
    ggtitle (paste0 (rs_name, " - COR num PUs vs. Total output error by Error Class")) +
    theme(plot.title = element_text(hjust = 0.5)) +    #  To center the title
...
gg_rsp_num_spp_vs_eucOutTot_facetted_by_FN_dominance <- function (rs_name,
 ...
 color = id
    ...
    ggtitle (paste0 (rs_name, " - COR num spp vs. Total output error by Error Class")) +
    theme(plot.title = element_text(hjust = 0.5)) +    #  To center the title
...
gg_rsp_num_spp_per_PU_vs_eucOutTot_facetted_by_FN_dominance <- function (rs_name,
 ...
 color = id
    ...
    ggtitle (paste0 (rs_name, " - COR num_spp_per_PU vs. Total output error by Error Class")) +
    theme(plot.title = element_text(hjust = 0.5)) +    #  To center the title
...
gg_rsp_correct_solution_cost_vs_eucOutTot_facetted_by_FN_dominance <- function (rs_name,
 ...
 color = id
    ...
    ggtitle (paste0 (rs_name, " - COR solution_cost vs. Total output error by Error Class")) +
    theme(plot.title = element_text(hjust = 0.5)) +    #  To center the title
...
gg_sppPUsum_vs_eucOutTot_facetted_by_FN_dominance <- function (rs_name,
 ...
 color = id
    ...
    ggtitle (paste0 (rs_name, " - COR sppPUsum vs. Total output error by Error Class")) +
    theme(plot.title = element_text(hjust = 0.5)) +    #  To center the title
...
gg_sppPUprod_vs_eucOutTot_facetted_by_FN_dominance <- function (rs_name,
 ...
 color = id
    ...
    ggtitle (paste0 (rs_name, " - COR sppPUprod vs. Total output error by Error Class")) +
    theme(plot.title = element_text(hjust = 0.5)) +    #  To center the title
...
gg_rsp_realized_FP_rate_vs_eucOutTot_facetted_by_FP_dominance <- function (rs_name,
 ...
 color = id
    ...
    ggtitle (paste0 (rs_name, " - Realized FP rate vs. Total output error by Error Class")) +
    theme(plot.title = element_text(hjust = 0.5)) +    #  To center the title
...
gg_rsp_num_PUs_vs_eucOutTot_facetted_by_FP_dominance <- function (rs_name,
 ...
 color = id
    ...
    ggtitle (paste0 (rs_name, " - COR num_PUs vs. Total output error by Error Class")) +
    theme(plot.title = element_text(hjust = 0.5)) +    #  To center the title
...
gg_rsp_num_spp_vs_eucOutTot_facetted_by_FP_dominance <- function (rs_name,
 ...
 color = id
    ...
    ggtitle (paste0 (rs_name, " - COR num_spp vs. Total output error by Error Class")) +
    theme(plot.title = element_text(hjust = 0.5)) +    #  To center the title
...
gg_rsp_correct_solution_cost_vs_eucOutTot_facetted_by_FP_dominance <- function (rs_name,
 ...
 color = id
    ...
    ggtitle (paste0 (rs_name, " - COR correct_solution_cost vs. Total output error by Error Class")) +
    theme(plot.title = element_text(hjust = 0.5)) +    #  To center the title
...
###  Compute the fit of prediction to problem size
...
###  Compute the fit of prediction to graph measures (redundancy, connectance)


### Plot Working COR OutErr vs. Fit Values from Graph Measures
...
### Plot Working COR OutErr vs. Fit Values from Cheating
...
### Plot Working COR OutErr vs. Fit Values from Cheating & Prob Size
