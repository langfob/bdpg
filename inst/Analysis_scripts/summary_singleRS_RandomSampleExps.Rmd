...
plot_pred_eval_for_train_and_test <- 
    ...
    print (regr.eval (train_true_values, 
                       train_preds, 
    ...
    print (regr.eval (test_true_values, 
                       test_preds, 
                       #stats = c ("mae", "mse"),    #, "rmse", "mape"))
    ...
    if (FALSE)
    {
    qplot (true_values, pred_values, 
           data=combined_pred_true_df, 
           facets = . ~ ds_label) +
#    + geom_smooth()
        geom_abline (intercept=0, slope=1  #, linetype, color, size
                       ) 
...
#    geom_point (mapping = aes (x = true_values, 
