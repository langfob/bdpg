...
#  script using commands like the ones below and they produce several
#  intermediate files that lead up to one ".csv" file for each reserve
#  selector, e.g., "Gurobi.csv".
